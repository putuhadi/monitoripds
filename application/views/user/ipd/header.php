          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Bidang Integrasi Pengolahan Data dan Diseminasi Statistik
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url().'admin/tambahkegiatan'; ?>">
            <i class="fa fa-th"></i> <span>Tambah Kegiatan</span>
          </a>
        </li>
        
        <li class="treeview"><a href="#"> <em class="fa fa-laptop"></em> <span>Update Kegiatan</span> <span class="pull-right-container"> <em class="fa fa-angle-left pull-right"></em> </span> </a>
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/uploadsop'; ?>"><i class="fa fa-circle-o"></i> Upload SOP</a></li>
            <li><a href="<?php echo base_url().'admin/kosong'; ?>"><i class="fa fa-circle-o"></i> Upload Kegiatan</a></li>
          </ul>
        </li>
